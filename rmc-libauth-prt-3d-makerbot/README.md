...
This function is used by the Library API /libauth/rmc/prt-3d-makerbot.csv  endpoint. It takes no parameters. It returns a CSV/text file only containing computing IDs of those who have permission to reserve the Canon C100.
